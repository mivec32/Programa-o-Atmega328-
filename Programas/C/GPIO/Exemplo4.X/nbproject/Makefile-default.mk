...
FINAL_IMAGE=${DISTDIR}/Exemplo4.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/Exemplo4.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=ATmega328P
# ------------------------------------------------------------------------------------
# Rules for buildStep: compile
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/newavr-main1.o: newavr-main1.c  .generated_files/flags/default/137127ffeee102e53fe9817ec1c8780b855b3cca .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}" 
...
${OBJECTDIR}/newavr-main1.o: newavr-main1.c  .generated_files/flags/default/bd629b727a3e55eab076cf273d9559295d015931 .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/newavr-main1.o.d 
	@${RM} ${OBJECTDIR}/newavr-main1.o 
...
${DISTDIR}/Exemplo4.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	...
	${MP_CC_DIR}\\avr-objcopy -O ihex "${DISTDIR}/Exemplo4.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}" "${DISTDIR}/Exemplo4.X.${IMAGE_TYPE}.hex"
endif
